...
gene_expression_data = pd.read_csv("PE_Wk11_MeV.csv", index_col=0)
...
columnRP_Mean = merged_Ascend_df.iloc[:, [0, 1, 15]]

# Select column 5 using iloc
column_StdDev = merged_Ascend_df_dropped.iloc[:, 14]
