...
plot_venn(set(PE13UP_HisSig['GeneID']), set(NP13UP_HisSig['GeneID']), 
          "PE13UP_HisSig", "NP13UP_HisSig", 
          "Overlap between PE13UP_HisSig and NP13UP_HisSig", 
          "PE13UP_NP13UP_HisSig_Venn.png")  # Pass the filename for saving

plot_venn(set(PE13DN_HisSig['GeneID']), set(NP13DN_HisSig['GeneID']), 
          "PE13DN_HisSig", "NP13DN_HisSig", 
          "Overlap between PE13DN_HisSig and NP13DN_HisSig", 
          "PE13DN_NP13DN_HisSig_Venn.png")  # Pass the filename for saving
